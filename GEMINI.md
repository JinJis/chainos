...
(:SUPPLIES)-[:SOURCED_FROM {extracted_value:"...", extracted_by:"gemini-3.5-flash"}]->(Filing_26Q1:Source)
```
...
> Keep this list current — Gemini relies on it. A root `Makefile` wraps these (`make help`).
